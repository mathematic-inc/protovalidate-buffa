...
use protovalidate_buffa_protos::buf::validate::{
    __buffa::{
        ...
        oneof::{
            bytes_rules, double_rules, duration_rules, field_rules, fixed32rules, fixed64rules,
            float_rules, int32rules, int64rules, s_fixed32rules, s_fixed64rules, s_int32rules,

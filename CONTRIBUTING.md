...
Mathematic uses AI agents to maintain this repository and implement changes. Reviewing an unsolicited pull request usually takes us longer than implementing an agreed proposal ourselves.

## Propose a change

1. [Start a Discussion](../../discussions/new) and describe the problem, the outcome you want, and any relevant context.
